...
- **Missing Validation**: Several validation scripts referenced in unified workflows were missing from `scripts/`.
...
- [ ] **Script Provisioning**: Pending implementation of missing `scripts/verify_*` tools (CON-1322).
