...
- **[Issue-only ITIL-aligned Workflow](./issue-only-itil5-workflow-baseline.md)**: Lightweight issue types, lifecycle, routing, ownership, and closure evidence for GitHub work.
