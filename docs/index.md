...
- **[Proposed Issue-only ITIL-aligned Workflow](./issue-only-itil5-workflow-baseline.md)**: Lightweight issue types, lifecycle, authority boundaries, routing, ownership, and closure evidence for public-safe GitHub work.
