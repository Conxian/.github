...
- **[Proposed Issue-only Operational Workflow](./issue-only-itil5-workflow.md)**: Lightweight issue types, lifecycle, authority boundaries, routing, ownership, and closure evidence for public-safe GitHub work.
